...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'proto.gizmo_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GIZMOSERVICE.methods_by_name[
        'DoOne']._serialized_options = b'\202\323\344\223\002,\"*/acme/api/v1/component/gizmo/{name}/do_one'
    _GIZMOSERVICE.methods_by_name['DoTwo']._options = None
    _GIZMOSERVICE.methods_by_name[
        'DoTwo']._serialized_options = b'\202\323\344\223\002,\"*/acme/api/v1/component/gizmo/{name}/do_two'
